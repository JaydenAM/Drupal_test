...
class __TwigTemplate_a1d357b8a50d7da9a547c1e20873e276 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 31, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "E:\\XAMPP\\htdocs\\drupal\\themes\\bootstrap\\templates\\input\\input--button--split.html.twig");
    }
